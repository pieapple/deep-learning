...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_outputs = hidden_outputs.reshape((1, -1))
        final_outputs = np.array(final_outputs, ndmin=2)
        final_outputs = final_outputs.reshape((1, -1))

        # TODO: Output error - Replace this value with your calculations.
        error = new_y - final_outputs # Output layer error is the difference between desired target and actual output.
        ...
        delta_weights_i_h += np.dot(new_X.T, hidden_error_term)
